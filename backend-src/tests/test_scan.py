...
def test_scan_requires_auth(client: FlaskClient) -> None:
    r = client.get("/api/scan/BOX001")
    assert r.status_code == 401


def test_scan_box(auth_client: FlaskClient) -> None:
...
def test_scan_tube(auth_client: FlaskClient) -> None:
...
def test_scan_box_takes_priority_over_tube(auth_client: FlaskClient) -> None:
...
def test_scan_not_found(auth_client: FlaskClient) -> None:
...
def test_search_returns_boxes(auth_client: FlaskClient) -> None:
...
def test_search_returns_tubes(auth_client: FlaskClient) -> None:
...
def test_search_returns_both(auth_client: FlaskClient) -> None:
